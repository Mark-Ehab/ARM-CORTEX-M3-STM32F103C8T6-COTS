...
typedef struct 
{
        ...
        volatile uint32_t NVIC_ISPR[3];         /* Interrupt set-pending registers */
        volatile uint32_t RESERVED2[29];        /* Reserved bits */
        volatile uint32_t NVIC_ICPR[3];         /* Interrupt clear-pending registers */
        volatile uint32_t RESERVED3[29];        /* Reserved bits */
        volatile uint32_t NVIC_IABR[3];         /* Interrupt active bit registers */
        volatile uint32_t RESERVED4[61];       	/* Reserved bits */
        volatile uint8_t  NVIC_IPR[80];         /* Interrupt priority bytes */
