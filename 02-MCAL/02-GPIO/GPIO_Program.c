...
void GPIO_Init(void)
{
	...
	GPIOA->CRL = CONC(GPIO_PORTA_PIN7_MODE,GPIO_PORTA_PIN6_MODE,GPIO_PORTA_PIN5_MODE,GPIO_PORTA_PIN4_MODE,GPIO_PORTA_PIN3_MODE,GPIO_PORTA_PIN2_MODE,GPIO_PORTA_PIN1_MODE,GPIO_PORTA_PIN0_MODE);
	GPIOA->CRH = CONC(GPIO_PORTA_PIN15_MODE,GPIO_PORTA_PIN14_MODE,GPIO_PORTA_PIN13_MODE,GPIO_PORTA_PIN12_MODE,GPIO_PORTA_PIN11_MODE,GPIO_PORTA_PIN10_MODE,GPIO_PORTA_PIN9_MODE,GPIO_PORTA_PIN8_MODE);
	GPIOB->CRL = CONC(GPIO_PORTB_PIN7_MODE,GPIO_PORTB_PIN6_MODE,GPIO_PORTB_PIN5_MODE,GPIO_PORTB_PIN4_MODE,GPIO_PORTB_PIN3_MODE,GPIO_PORTB_PIN2_MODE,GPIO_PORTB_PIN1_MODE,GPIO_PORTB_PIN0_MODE);
	GPIOB->CRH = CONC(GPIO_PORTB_PIN15_MODE,GPIO_PORTB_PIN14_MODE,GPIO_PORTB_PIN13_MODE,GPIO_PORTB_PIN12_MODE,GPIO_PORTB_PIN11_MODE,GPIO_PORTB_PIN10_MODE,GPIO_PORTB_PIN9_MODE,GPIO_PORTB_PIN8_MODE);
	GPIOC->CRH = CONC(GPIO_PORTC_PIN15_MODE,GPIO_PORTC_PIN14_MODE,GPIO_PORTC_PIN13_MODE,GPIO_PORTC_PIN_DUMMY_MODE,GPIO_PORTC_PIN_DUMMY_MODE,GPIO_PORTC_PIN_DUMMY_MODE,GPIO_PORTC_PIN_DUMMY_MODE,GPIO_PORTC_PIN_DUMMY_MODE);

	/* Set GPIO Ports Initial Values Based on Configuration File */
	GPIOA->ODR = (uint32_t)CONC2(GPIO_PORTA_PIN15_INITIAL_VALUE,GPIO_PORTA_PIN14_INITIAL_VALUE,GPIO_PORTA_PIN13_INITIAL_VALUE,GPIO_PORTA_PIN12_INITIAL_VALUE,GPIO_PORTA_PIN11_INITIAL_VALUE,GPIO_PORTA_PIN10_INITIAL_VALUE,GPIO_PORTA_PIN9_INITIAL_VALUE,GPIO_PORTA_PIN8_INITIAL_VALUE,GPIO_PORTA_PIN7_INITIAL_VALUE,GPIO_PORTA_PIN6_INITIAL_VALUE,GPIO_PORTA_PIN5_INITIAL_VALUE,GPIO_PORTA_PIN4_INITIAL_VALUE,GPIO_PORTA_PIN3_INITIAL_VALUE,GPIO_PORTA_PIN2_INITIAL_VALUE,GPIO_PORTA_PIN1_INITIAL_VALUE,GPIO_PORTA_PIN0_INITIAL_VALUE);
	GPIOB->ODR = (uint32_t)CONC2(GPIO_PORTB_PIN15_INITIAL_VALUE,GPIO_PORTB_PIN14_INITIAL_VALUE,GPIO_PORTB_PIN13_INITIAL_VALUE,GPIO_PORTB_PIN12_INITIAL_VALUE,GPIO_PORTB_PIN11_INITIAL_VALUE,GPIO_PORTB_PIN10_INITIAL_VALUE,GPIO_PORTB_PIN9_INITIAL_VALUE,GPIO_PORTB_PIN8_INITIAL_VALUE,GPIO_PORTB_PIN7_INITIAL_VALUE,GPIO_PORTB_PIN6_INITIAL_VALUE,GPIO_PORTB_PIN5_INITIAL_VALUE,GPIO_PORTB_PIN4_INITIAL_VALUE,GPIO_PORTB_PIN3_INITIAL_VALUE,GPIO_PORTB_PIN2_INITIAL_VALUE,GPIO_PORTB_PIN1_INITIAL_VALUE,GPIO_PORTB_PIN0_INITIAL_VALUE);
	GPIOC->ODR = (uint32_t)CONC2(GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN14_INITIAL_VALUE,GPIO_PORTC_PIN13_INITIAL_VALUE,GPIO_PORTC_PIN_DUMMY_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE,GPIO_PORTC_PIN15_INITIAL_VALUE);
}
		...
		if((Copy_Port >= GPIO_PORT_A && Copy_Port <= GPIO_PORT_C) && (Copy_Pin >= GPIO_PIN_0 && Copy_Pin <= GPIO_PIN_15))
		{
				...
				switch(Copy_Port)
				{
					case GPIO_PORT_A:
						...
						*Copy_pValue = GET_BIT(GPIOA->IDR,Copy_Pin);
						break;

					case GPIO_PORT_B:

						/* Get pin value in IDR register */
						*Copy_pValue = GET_BIT(GPIOB->IDR,Copy_Pin);
						break;

					case GPIO_PORT_C:

						/* Get pin value in IDR register */
						*Copy_pValue = GET_BIT(GPIOC->IDR,Copy_Pin);
						break;
				}
		}
		else
